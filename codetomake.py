...
with open('videos1.csv', 'w', newline='', encoding='utf-8') as file:
    writer = csv.writer(file)
    writer.writerow(['Relation', 'URL'])  # Column headers
    for relation, url in data.items():
        writer.writerow([relation, url])
